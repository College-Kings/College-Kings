...
label mc_wolves_sun_aft:
    ...
    if not hcGirl == "lauren":
        ...
        $ KiwiiService.add_replies(kiwii_post,
            KiwiiReply(_("I'm glad you guys had fun"), number_likes=320, next_message=v8s16_kiwii_reply1),
            KiwiiReply(_("Wow, you two look great!"), number_likes=343, next_message=v8s16_kiwii_reply2)
        )
    ...
    $ KiwiiService.add_replies(kiwii_post,
        KiwiiReply(_("How many bikinis did you buy? Haha."), number_likes=350, next_message=v8s16_kiwii_reply3),
        KiwiiReply(_("Did you buy me anything?"), number_likes=337, next_message=v8s16_kiwii_reply4)
    )
...
label mc_apes_sun_aft:
    ...
    if not hcGirl == "lauren":
        ...
        $ KiwiiService.new_comment(kiwii_post, ryan, _("Booba"), number_likes=renpy.random.randint(15, 35))
        $ KiwiiService.add_replies(kiwii_post,
            KiwiiReply(_("I'm glad you guys had fun"), number_likes=320, next_message=v8s16_kiwiiReply1),
            KiwiiReply(_("Wow, you two look great!"), number_likes=343, next_message=v8s16_kiwiiReply2)
        )
    ...
    $ KiwiiService.new_comment(kiwii_post, imre, _("Looking good"), number_likes=renpy.random.randint(15, 35))
    $ KiwiiService.add_replies(kiwii_post,
        KiwiiReply(_("How many bikinis did you buy? Haha."), number_likes=350, next_message=v8s16_kiwiiReply3),
        KiwiiReply(_("Did you buy me anything?"), number_likes=337, next_message=v8s16_kiwiiReply4)
    )
