...
label mc_wolves_sun_aft:
    ...
    $ v8s16_kiwiiPost1.newComment(aubrey, _("Awww, I love hanging out with you <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
    $ v8s16_kiwiiPost1.newComment(nora, _("Looking great Aubrey!"), numberLikes=renpy.random.randint(15, 35), queue=False)
    $ v8s16_kiwiiPost1.newComment(lindsey, _("Next time invite me along"), numberLikes=renpy.random.randint(15, 35), queue=False)
    ...
    if not hcGirl == "lauren":
        ...
        $ v8s16_kiwiiPost2.newComment(cameron, _("Teacher's pet!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v8s16_kiwiiPost2.newComment(ryan, _("Booba"), numberLikes=renpy.random.randint(15, 35), queue=False)        
    ...
    $ v8s16_kiwiiPost3.newComment(aubrey, _("Wish I could of been there to try things with you"), numberLikes=renpy.random.randint(15, 35), queue=False)
    $ v8s16_kiwiiPost3.newComment(imre, _("Looking good"), numberLikes=renpy.random.randint(15, 35), queue=False)
