...
label after_apes_ceremony:
    ...
    if apesVids == 4:
        $ kiwii_post = KiwiiService.new_comment(kiwii_post, grayson, _("And congrats to the prodigal son, [name], for getting the perfect score. Looks like somebody's coming for my throne!"), number_likes=renpy.random.randint(140, 150))
