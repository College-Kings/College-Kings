...
label v8_scene24_wolves:
    ...
    $ v8s25_kiwiiPost = KiwiiPost("MC", "v8/mcpost1w.webp", "Ugh someone save me pls", numberLikes=2)
...
label v8_scene24_apes:
    ...
    $ v8s25_kiwiiPost = KiwiiPost("MC", "v8/mcpost1a.webp", "Ugh someone save me pls", numberLikes=2)
...
label phn_riley11_setup:
    $ contact_Riley.newMessage(_("Bad day?"), queue=False)
    $ contact_Riley.addReply(_("I've read the same page four times :/"))
