...
label v11_big_ben:
    ...
    $ v11s24_kiwiiPost1.newComment("Chris", _("Someone's gonna be upset in the morning!"), queue=False)
    $ v11s24_kiwiiPost1.newComment("Nora", _("Sebastian that's cruel!!"), queue=False)

    $ v11s24_kiwiiPost2 = KiwiiPost("Imre", "v11/v11_imrebunny.webp", _("Say hello to our newest Wolf recruit"), numberLikes=314)
    $ v11s24_kiwiiPost2.newComment("Aubrey", _("Awww cute!!"), queue=False)
    $ v11s24_kiwiiPost2.newComment("Nora", _("That thing stinks!"), queue=False)
