...
label v11_big_ben:
    ...
    $ v11s24_kiwiiPost1.newComment(chris, _("Someone's gonna be upset in the morning!"), numberLikes=renpy.random.randint(15, 35), queue=False)
    $ v11s24_kiwiiPost1.newComment(nora, _("Sebastian that's cruel!!"), numberLikes=renpy.random.randint(15, 35), queue=False)

    $ v11s24_kiwiiPost2 = KiwiiPost(imre, "v11/v11_imrebunny.webp", _("Say hello to our newest Wolf recruit"), numberLikes=314)
    $ v11s24_kiwiiPost2.newComment(aubrey, _("Awww cute!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
    $ v11s24_kiwiiPost2.newComment(nora, _("That thing stinks!"), numberLikes=renpy.random.randint(15, 35), queue=False)
