...
label v11_dinner_with_lauren:
    ...
    scene v11dwl1b # Fpp. same 1, slight different pose, mouth open
    with dissolve

    la "Well, what are you craving?"

    scene v11dwl1c # Fpp. same 1, slight different pose, mouth closed
    with dissolve
    ...
    if CharacterService.is_girlfriend(lauren):
        ...
        scene v11dwl2 # FPP. Show imre walking by, mouth open, smiling and waving
        with dissolve

        # -Imre walks by their table-

        imre "What's up, [name]? Lauren."

        scene v11dwl2a # FPP. Show imre now stopped for conversation, mouth closed
        with dissolve
        ...
        scene v11dwl2b # FPP. Show imre now stopped for conversation, mouth open
        with dissolve
        ...
        scene v11dwl3 # FPP. Show imre walking away
        with dissolve
    ...
    scene v11dwl5 # TPP. Show Lauren and MC talking
    with fade

    pause 2

    scene v11dwl6 # TPP. Show Riley and Amber talking and eating
    with fade

    pause 2

    scene v11dwl7 # TPP. Show Lindsey and charli talking and eating
    with fade

    pause 2

    scene v11dwl8 # FPP. Show lauren, mouth open slight smile, (table now has plates on them (food as been finished so plates should be empty from this point onwards))
    with dissolve
    ...
    scene v11dwl10 # FPP. Imre walks over, giggling, mouth open
    with dissolve

    imre "*Whisper* Have a nice dinner with Blue Ball Lauren? *Laughs*"

    scene v11dwl10a # FPP. Imre walks over, giggling, mouth closed
    with dissolve
    ...
    scene v11dwl14 # FPP. Show mr lee stood infront of the students, mouth open
    with dissolve
