...
label v11_roommate:
    ...
    if not v11_riley_roomate:
        ...
        if chloe.relationship.value <= Relationship.MAD.value:
            ...
            $ v11s19_kiwiiPost2.newComment(aubrey, _("Look at you two!"), numberLikes=renpy.random.randint(15, 35), queue=False)
            ...
            $ v11s19_kiwiiPost1.newComment(aubrey, _("Look at you two!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        $ v11s19_kiwiiPost3.newComment(ryan, _("Good roommate pick!"), numberLikes=renpy.random.randint(15, 35), queue=False)
