...
label v11_amber_bar:
    ...
    $ KiwiiService.add_replies(kiwii_post,
        KiwiiReply(_("Woah! Hot as always"), v11s38_kiwii_reply1, number_likes=renpy.random.randint(260, 340)),
        KiwiiReply(_("Thanks for the invite... lol"), v11s38_kiwii_reply2, number_likes=renpy.random.randint(250, 330))
    )
