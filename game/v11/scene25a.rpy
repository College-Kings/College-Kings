...
label v11_hotel_charlie_bar:
    ...
    if chloe.relationship >= Relationship.FWB and CharacterService.is_girlfriend(lauren, Relationship.GIRLFRIEND) and aubrey.relationship >= Relationship.FWB:
        charli "How many girls have you messed with on this trip alone? Chloe, Aubrey, Lauren?"

    elif CharacterService.is_girlfriend(lauren, Relationship.GIRLFRIEND) and aubrey.relationship >= Relationship.FWB:
    ...
    elif CharacterService.is_girlfriend(lauren, Relationship.GIRLFRIEND) and chloe.relationship >= Relationship.FWB:
