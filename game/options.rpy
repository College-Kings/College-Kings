...
define config.name = _("College Kings")
...
define build.directory_name = "CollegeKings{}".format("" if config.enable_steam else config.version)
...
define config.save_directory = "CollegeKings"
