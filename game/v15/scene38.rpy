...
label v15s38:
    ...
    # -Regardless-
    if aubrey_tamed: # -if AubreyTamed
    ...
    if v15_s12_lindsey_pb_inviteSebastian = False: # -if Grayson
        ...
        menu:
            ...
            "Raise your hands": # -if Raise your hands
                ...
                if aubrey_tamed: # -if AubreyTamed, she raises hers after she sees MC raise his, and she winks at him-
    ...
    menu:
        "Stop the questioning": # -if Stop the questioning (and helped Autumn with boxes at dog shelter and/or went to the protest with her in Act1, creates AutumnTrust)
            ...
            elif AutumnLunchBreak: # VERIFY THIS VARIABLE - SEEMS TO HAVE MULTIPLE CONDITIONS # Helped with boxes
                $ AutumnTrust = True
    ...
    if v12_lindsey_sex: ### VERIFY CORRECT VARIABLE # -if MC had 69 with Lindsey
        scene v15s38_7e
        with dissolve
    ...
    if v15_s12_lindsey_pb_inviteSebastian: # -if Sebastian
        scene v15s38_8
        with dissolve
