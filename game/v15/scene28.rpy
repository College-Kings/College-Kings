...
label v15s28:
    ...
    if jennyrs: # -if JennyRs
        ...
        elif penelopeloyal: # -if PenelopeFriend
    ...
    elif (v14_PenRomScene and jennyfriend): # -if JennyFriend and PenelopeLoyal
        scene v15s28_3a
        with dissolve
    ...
    elif (joinapes and v14_Samantha_clean): # -if Apes and SamanthaSober from 14.53a (MC
        scene v15s28_9
        with dissolve
    ...
    elif (joinapes and (v14_SamanthaDrugs = False) and (v14_samantha_sex = False)): # -if Apes and SamanthaDrugs from 14.53a (let her continue drugs) and DENIED sex afterwards
        scene v15s28_9a
        with dissolve
    ...
    elif (joinapes (v14_SamanthaDrugs = False) and v14_samantha_sex): # -if Apes and SamanthaDrugs from 14.53a (let her continue drugs) and ACCEPTED sex
        scene v15s28_9
        with dissolve
    ...
    elif (penelopeloyal): # -if PenelopeLoyal
    ...
    if (jennyrs and penelopers): # -if JennyRs and PenelopeRs (Lagoon with Jenny but had RS with Penelope prior to that)
    ...
    elif joinapes: # -if Apes, transition to Scene 30-
        jump v15s30