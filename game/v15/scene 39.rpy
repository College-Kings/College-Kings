...
label v15s39:
    ...
    if v15_lindsey_pb_alcohol: #####PLACEHOLDER, OR UNKNOWN VARIABLE#####
        ...
        barw "We have a full range of drinks for you tonight, from beer to prosecco to tequila, even cocktails, all included in your VIP party package."
    ...
    if not v15_lindsey_inviteseb: #####POSSIBLY INCORRECT VARIABLE#####
        ...
        barw "Would you prefer a mocktail, sir?"
        ...
        barw "They're cocktails without alcohol."
            ...
            menu:
                ...
                "Try to trick her":
                    ...
                    if kct == "confident":
                        ...
                        scene v15s39_8u # FPP. same as v15s39_8b Lindsey shrugs her shoulders, increases to a full smile, still looking at MC, mouth is still open
                        with dissolve
