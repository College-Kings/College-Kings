    ...
    if v14_emily_ily:
        ...
        menu:
            "Sext Emily":
                ...
                if config_censored:
                    call screen censoredPopup("v15s30_nsfwSkipLabel1")
                ...
                if config_censored:
                    ...
                    $ emily.messenger.addImgReply("images/v15/Scene 29/emilynude_MC_DicPic1.webp") # Ignore as Reused from scene 29
