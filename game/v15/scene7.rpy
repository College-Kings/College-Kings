...
label v15s7:
    ...
    if (v14s51_take_diary or v14s51_take_money): # -if MC stole any of Chloe's money and/or her diary from her room
        ...
        if (v14s51_take_cash_large and v14s51_take_cash_small = False): # -if the $900 was stolen
            scene v15s7_1a
            with dissolve
        ...
        elif (v14s51_take_cash_small and v14s51_take_cash_large = False): # -if $300 was stolen
            scene v15s7_1a
            with dissolve
        ...
        elif (v14s51_take_diary and v14s51_take_money = False): # -if ONLY Chloe's diary was stolen
            scene v15s7_1a
            with dissolve
            ...
            menu:
                "You have a diary?":
                    ...
                    if chloegf: # -Chloe obviously angry, if ChloeGF give a sus point-
                        $ chloeSus += 1
                    ...
                    else: # -if not ChloeGF or ChloeRS
                        scene v15s7_1a
                        with dissolve
        ...
        if (v14_help_chloe = False): # -if MC is not helping Chloe
