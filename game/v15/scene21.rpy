...
if mr_lee_meeting:
    ...
    scene v15s21_3c FPP. # FPP. same as v15s21_3a Mr. Lee's mouth is open
    with dissolve
    ...
    if ###### -if TookNotes and clicks on the journal five times- ######:
    ...
    if v13_bonsai: # -if MC gave Mr. Lee the bonsai tree gift in Amsterdam (had scene 13.57a instead of 13.57) = (bonus correct_points +1)
        $ addpoint v15_meeting += 1
    ...
    if v15_meeting == 0 or v15_meeting == 1 and not kct == "loyal":
    ...
    if v15s9_mad_at_ms_rose and not V15_ms_rose_sex:
    ...
    elif v15s9_mad_at_ms_rose and V15_ms_rose_sex: # -if MC had kitchen sex with Ms Rose
    ...
    if v15_meeting == 0 or v15_meeting == 1 and not kct == "confident":  # -if scored 1 point and Confident KCT = false, or if scored 0 points regardless of KCT
