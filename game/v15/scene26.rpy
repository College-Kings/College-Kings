...
label v15s26:
    ...
    ### COULD NOT FIND VARIABLE IN LATEST variables.rpy - will need to be updated. Think it has something to do with freeroam12, but not sure how to check against it
    if INSERT_VARIABLE: # -if MC went to Chloe's room to try and steal money
