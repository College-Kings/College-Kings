    ...
    menu:
        ...
        "A little extra effort...":
            ...
            if not (v12_lauren_points >= 3) and not (kct == "loyal"):
                ...
                if laurenrs and (chloe.relationship.value < Relationship.FWB.value) and (aubrey.relationship.value < Relationship.FWB.value) and (evelyn.relationship.value < Relationship.LIKES.value) and not emilyrs and (riley.relationship.value < Relationship.FWB.value) and (amber.relationship.value < Relationship.FWB.value) and (penelope.relationship.value < Relationship.LIKES.value) and (ms_rose.relationship.value < Relationship.FWB.value) and (lindsey.relationship.value < Relationship.KISS.value) and (candy.relationship.value < Relationship.FWB.value) and not v11_samantha_spa:
