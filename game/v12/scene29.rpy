    ...
    menu:
        ...
        "A little extra effort...":
            ...
            if not (v12_lauren_points >= 3) and not (kct == "loyal"):
                ...
                if laurenrs and not chloers and not aubreyrs and (evelyn.relationship.value < Relationship.LIKES.value) and not emilyrs and not rileyrs and not amberrs and not penelopers and not msrosers and not lindseyrs and not lindseyfirstkiss and (candy.relationship.value < Relationship.FWB.value) and not v11_samantha_spa:
