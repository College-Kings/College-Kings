    ...
    menu:
        ...
        "A little extra effort...":
            ...
            if v12_lauren_points >= 3 or reputation() == Reputations.LOYAL:
                ...
                if CharacterService.is_girlfriend(lauren) and (amber.relationship < Relationship.FWB) and (aubrey.relationship < Relationship.FWB) and (candy.relationship < Relationship.FWB) and (chloe.relationship < Relationship.FWB) and (emily.relationship < Relationship.FWB) and (not v6_evelyn_successful_date) and (lindsey.relationship < Relationship.KISSED) and (ms_rose.relationship < Relationship.FWB) and (penelope.relationship < Relationship.LIKES) and (riley.relationship < Relationship.FWB) and (samantha.relationship < Relationship.MOVE):
