    ...
    menu:
        ...
        "A little extra effort...":
            ...
            if not (v12_lauren_points >= 3) and not (kct == "loyal"):
                ...
                if laurenrs and not chloers and (aubrey.relationship.value < Relationship.FWB.value) and (evelyn.relationship.value < Relationship.LIKES.value) and not emilyrs and not rileyrs and not amberrs and (penelope.relationship.value < Relationship.LIKES.value) and not msrosers and (lindsey.relationship.value < Relationship.FWB.value) and not lindseyfirstkiss and (candy.relationship.value < Relationship.FWB.value) and not v11_samantha_spa:
