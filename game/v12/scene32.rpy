...
init python:
    def v12s32kiwiiPost1_Reply1():
        v12s32kiwiiPost1.newComment(naomi, _("Hehe, you too! Hope to see you soon...;)"), numberLikes=renpy.random.randint(583, 912))
    ...
    def v12s32kiwiiPost1_Reply2():
        v12s32kiwiiPost1.newComment(aubrey, _("You're so welcome... Today was amazing. <3"), numberLikes=renpy.random.randint(253, 462))
        v12s32kiwiiPost1.newComment(chloe, _("OMG!?!?!?!"), numberLikes=renpy.random.randint(124,354))
        v12s32kiwiiPost1.newComment(imre, _("Bro... Is that you?!"), mentions=[mc], numberLikes=renpy.random.randint(53,93))
