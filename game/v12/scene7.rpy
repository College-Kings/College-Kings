label v12s7fr:
    ...
    show screen murderButtonOverlay
...
label v12s7_aubrey1:
    ...
    menu:
        "It does hurt pretty bad":
            ...
            #call screen return to aubreys screen.
        "Didn't even feel it":
            scene v12ferau1a
            with dissolve
...
label v12s7_emily1:
    ...
    scene v12ferem4 # TPP. Show mc walking away
    with dissolve
...
label v12s7_emily2:
    ...
    scene v12feremi2 # TPP. Show mc walking off.
    with dissolve
