...
default nora = NonPlayableCharacter("Nora", "Nora_12") #Relationship progression: FRIEND, FWB
...
default evelyn = NonPlayableCharacter("Evelyn") #Relationship progression: FRIEND, DATE, LIKES, KISS
