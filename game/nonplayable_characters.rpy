...
default beth = CustomCharacter("Beth", "beth.webp")
default iris = CustomCharacter("Iris", "iris.webp")
default samantha = CustomCharacter("Samantha", "samantha.webp")
default emmy = CustomCharacter("Emmy", "emmy.webp")