...
screen load():
    ...
    text "We do our best to retain save integrety with every update, however due to the dynamic nature of game development some saves might break. If you experiance a save problem please let us know via the support channel on the College Kings Discord.\nYou can find a link to our Discord in the Main Menu.":
