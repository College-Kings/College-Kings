...
init python:
    def v9s35_reply1():
        ...
        contact_Chloe.addReply("I miss you too.", v9s35_reply2)
        contact_Chloe.addReply("That's better haha", v9s35_reply3)
    ...
    def v9s35_reply3():
        ...
        contact_Chloe.addReply("Yeah, of course", v9s35_reply4)
        contact_Chloe.addReply("You need to ask? :)", v9s35_reply5)
    ...
    def v9s35_reply5():
        ...
        contact_Chloe.addReply("OMG! I miss those!", v9s35_reply6)
        contact_Chloe.addReply("OMG! You are magnificent!", "s35_ChloeReplyWRs5")
    
    def v9s35_reply6():
        contact_Chloe.newMessage("Thought you'd like that :)")
        contact_Chloe.addReply("Like? I love it! That just made my whole day better.")
        contact_Chloe.newMessage("Awww, such a charmer haha. Your turn. Let me see yours.")
        contact_Chloe.addReply("Your wish is my command.")
        contact_Chloe.addImgReply("images/v9/Scene 35/mcdickwolves.webp")
        contact_Chloe.newMessage("God, I miss that cock. ")
        contact_Chloe.addReply("Can I come over? Haha.")
        contact_Chloe.newMessage("I wish. I have a lot to do for tomorrow, but that would be nice.")
        contact_Chloe.addReply("Yeah, that would be great. Would like to see more of you.")
        contact_Chloe.newMessage("No, that's all the pics I'm sending haha.")
        contact_Chloe.addReply("That's not what I meant, haha.")
        contact_Chloe.newMessage("Haha, I know what you meant. I'd like that, too.")
        contact_Chloe.addReply("Well, let me know when you're free and I'll make time.")
        contact_Chloe.newMessage("I definitely will. Goodnight [name]")
        contact_Chloe.addReply("Goodnight, gorgeous.", v9s35_reply7)
        contact_Chloe.addReply("Goodnight, Chloe.")
    ...
    def v9s35_reply8():
        ...
        contact_Chloe.addReply("Haha, me too. Kinda want to throw my books out the window.")
        contact_Chloe.newMessage("Haha. I wish I could just leave the house and not worry about it.")
        contact_Chloe.addReply("Me too. Wanna go for a walk together?")
        contact_Chloe.newMessage("I wish. I have a lot to do for tomorrow, but that would be nice.")
        contact_Chloe.addReply("Yeah, it would be.")
        contact_Chloe.newMessage("I think I'll soak in the tub for a bit.")
        contact_Chloe.addReply("Can I join you?")
        contact_Chloe.newMessage("Haha! You wish :)")
        contact_Chloe.addReply("Hey, a guy can dream, right?")
        contact_Chloe.newMessage("Yeah, but it's a dream.")
        contact_Chloe.addReply("For now haha.")
        contact_Chloe.newMessage("Haha, yeah for now. Well, I'll let you go. Was great to talk to you [name].")
        contact_Chloe.addReply("Likewise. Don't be a stranger.")
        contact_Chloe.addReply("Yeah, it was nice to hear from you.")
...
label v9_room_sat_aft:
    if joinwolves:
        ...
        $ contact_Chloe.newMessage("Hey [name], what you up to?", queue=False)
        $ contact_Chloe.addReply("Nothing much. Just relaxing. I'm kind of tired.")
        $ contact_Chloe.newMessage("Awwww. Long day?")
        if chloers:
            $ contact_Chloe.addReply("Yeah haha, I feel wiped.", v9s35_reply1)
        else:
            $ contact_Chloe.addReply("Yeah haha, I feel wiped.", v9s35_reply8)
