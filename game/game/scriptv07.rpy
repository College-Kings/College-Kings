...
######## SCENE 1 Chris in Wolves secret room
    ...
    if jwt:
        if relics > 3:
            ...
            u "(There was this empty room upstairs... This'd be the perfect place for some alone time with a girl... I should ask them. Haha.)"
            
        else:
            scene fr3office
            u "(Empty room... All alone. This'd be the perfect place for some alone time with a girl... I should ask them. Haha.)"
...
##### SCENE 7 LAUREN'S DORM
    ...
    menu:
        ...
        "Come clean about Emily" if not jwt:
            $ addPoint("bf", 1)
            jump hj_a
...
########## SCENE 18 PENELOPE AFTER HISTORY
    ...
    if emilyrs and bowling and not jwt:
...
########## SCENE 21 ASKING AMBER
    ...
    if kct == "popular" or jwt:
        ...
        if jwt:
            am "How about you come in now? I promise it'll be a lot of fun."
        else:
        ...
        menu:
            "Alright, I'm in.":
                ...
                with dissolve
                if jwt:
                    am "Great, come in then."
                    jump jwt_amberhocodate
            ...
            "I'd rather go to the dance." if not jwt:
                $ addPoint("bf", 1)
...
########## SCENE 28 ASKING RILEY
    ...
    if rileyrs or kct == "confident" or jwt:
        $ hcGirl = "riley"
        $ rileyrs = True
