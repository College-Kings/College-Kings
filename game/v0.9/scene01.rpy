...
$ showphone = True
$ phoneexit = "v9_phn_imre1"
$ contact_Imre.addReply("You here yet?", "v9_phn_imre1_a1")
...
label v9_phn_imre1_a1a2:
$ contact_Imre.newMessage("Me too. See ya there!")
call screen messager(contact_Imre)

label v9_phn_imre1_a1b1:
