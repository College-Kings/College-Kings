...
label v9_room_w_chris:
    ...
    ### $ contact_Hey,.addReply("how's it going?")
    ### $ contact_Julia.newMessage("Hey! I was just thinking about you. How's school?")
    ### $ contact_Good..addReply("About to go have dinner with some of the guys in my building.")
    ### $ contact_Julia.newMessage("I'm glad you're making friends. I'm so proud of you.")
    ### $ contact_Aww,.addReply("don't make me blush. They'll be here any second. Talk to you later.")
