...
image v8s19dyn:
    "v8s19b" # Chloe licking side of MC's shaft (top) while looking into the camera teasingly
    with dissolve
    pause 0.5

    "v8s19c" # Same as v8s19b but licking a little lower
    with dissolve
    pause 0.3

    "v8s19d" # Same as v8s19b but even lower, should not be fully at bottom of the dick though
    with dissolve
    pause 0.5
