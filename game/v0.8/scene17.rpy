...
default penelopeMessage6 = Message(contact_Penelope, "")
default penelopeMessage6_a = Message(contact_Penelope, "Better, thanks to you")
default penelopeMessage6_a1 = Message(contact_Penelope, "Thank you! :)")

label msrose_moving:
$ penelopeMessage6.addReply("Hey, how you holding up?", phn_penelope6_a)
...
$ contact_Penelope.newMessage(penelopeMessage6)
$ showphone = True
...
label phn_penelope6:
if not penelopeMessage6.reply and not penelopeMessage6_a.reply:
...
$ contact_Penelope.newMessage(penelopeMessage6_a)
call screen messager(contact_Penelope)

label phn_penelope6_a1:
$ contact_Penelope.newMessage(penelopeMessage6_a1)
call screen messager(contact_Penelope)
