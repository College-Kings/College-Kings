...
default chloeMessage11 = Message(contact_Chloe, "Congrats on getting in. Looks like we'll be seeing a lot of each other.")
default chloeMessage11_a = Message(contact_Chloe, "Guess you'll have to wait and see ;)")
default chloeMessage11_a1 = Message(contact_Chloe, "You're such a flirt. Have a good night!")
default chloeMessage11_b = Message(contact_Chloe, "Aww, I like talking to you too. You're sweet.")
default chloeMessage11_b1 = Message(contact_Chloe, "Sweet and cute ;)")
default chloeMessage11_b2 = Message(contact_Chloe, "Good night.")
...
if apesVids == 4:
    $ KiwiiPost6.addComment("Aubrey", "Damn, perfect score? Would love to see you in action in the ring ;)", mentions="MC", numberLikes=renpy.random.randint(80, 90))
else:
    $ KiwiiPost6.addComment("Aubrey", "Congrats guys! Couldn't be at the ceremony cause of some stupid shit :/", numberLikes=renpy.random.randint(50, 60))
$ KiwiiPost6.addComment("Mason", "So proud of you guys especially my man", mentions="Caleb", numberLikes=renpy.random.randint(40, 50))
$ KiwiiPost6.addComment("Emily", "Yaayyy! Congrats", mentions = "MC", numberLikes=renpy.random.randint(25, 35))
if apesVids == 4:
    $ KiwiiPost6.addComment("Elijah", "Hmph ridiculous! Like those are the perfect scores that matter...", numberLikes=renpy.random.randint(3, 6))
    $ KiwiiPost6.addComment("Cameron", "Just shut the fuck up and never come back", mentions="Elijah", numberLikes=renpy.random.randint(75, 85))
    $ KiwiiPost6.addComment("Cameron", "That is unless you want me to kick your ass, then of course knock yourself out", mentions="Elijah", numberLikes=renpy.random.randint(110, 120))
...
$ chloeMessage11.addReply("Exactly how much is a lot? ;)", "phn_chloe11_a")
$ chloeMessage11_a.addReply("I'm moving my stuff now. How about we get started tonight?", "phn_chloe11_a1")
$ chloeMessage11.addReply("Hope so. I like talking to you.", "phn_chloe11_b")
$ chloeMessage11_b.addReply("Sweet? Not hot? Or sexy? Or... anything but sweet?", "phn_chloe11_b1")
$ chloeMessage11_b1.addReply("I'll take it. For now. Talk to you when I get settled.", "phn_chloe11_b2")

$ phoneexit = "phn_chloe11"
$ contact_Chloe.newMessage(chloeMessage11)
$ showphone = True
...
label phn_chloe11:
if not ((chloeMessage11.reply and chloeMessage11_a.reply) or (chloeMessage11.reply and chloeMessage11_b.reply and chloeMessage11_b1.reply)):
...
label phn_chloe11_a:
$ chloeMsg11Reply = 1
$ contact_Chloe.newMessage(chloeMessage11_a)
call screen messager(contact_Chloe)

label phn_chloe11_a1:
$ contact_Chloe.newMessage(chloeMessage11_a1)
call screen messager(contact_Chloe)

label phn_chloe11_b:
$ chloeMsg11Reply = 2
$ contact_Chloe.newMessage(chloeMessage11_b)
call screen messager(contact_Chloe)

label phn_chloe11_b1:
$ contact_Chloe.newMessage(chloeMessage11_b1)
call screen messager(contact_Chloe)

label phn_chloe11_b2:
$ contact_Chloe.newMessage(chloeMessage11_b2)
call screen messager(contact_Chloe)
