...
label v14s43c:
    ...
    if penelope.relationship >= Relationship.LOYAL and (chloe.relationship >= Relationship.GIRLFRIEND or lauren.relationship >= Relationship.GIRLFRIEND):
    ...
    if penelope.relationship >= Relationship.LOYAL and v14_PenRomScene:
