...
label test2:
    python:
        ...
        lindsey_board.add_approach("Steal from the Chicks' treasury", opinion="\"I know this sounds crazy... Why would I want to steal from the Chicks', right? Well, Chloe holds all of our funds in her bedroom and right now she's using them towards her campaign. We have to get that money before she spends it all on herself.\"")
        ...
        lindsey_board.add_subtask(1, "Make sure Chloe isn't home with concert tickets ",
            opinion= "\"If we want to get Chloe away from her room for the night, all we need are two tickets to the concert happening this Thursday. She won't be able to say no, she's been wanting to see this band for a while.\"",
            people=[mc, chloe])
        ...
        lindsey_board.add_task(1, "MC steals the Chicks' money from Chloe's room",
