...
label v14s31a:
    ...
    # up 1
    scene v14s31a_4a # Same angle as 4, MC arms extended in upper pushup position
    with dissolve
    ...
    # up 1
    scene v14s31a_4d # TPP Same angle as 4, MC in upper situp position, arms crossed over chest, elbows touching knees
    with dissolve
