        ...
        vbox:
            ...
            hbox:
                ...
                if len(task.people) < 4:
                    ...
                    null width 35
                    text "+{}".format(len(task.people) - 3) color "#777777" yalign 0.5
...
screen planning_board_confirm_task(planning_board, task):
    ...
    hbox:
        ...
        imagebutton:
            idle "images/v14/chicks_presidency_race/planning_boards/confirm.png"
            action [SetField(planning_board, "selected_task", task), Hide("planning_board_confirm_task"), Hide("planning_board_task_desc"), Hide("planning_board")]

        imagebutton:
            idle "images/v14/chicks_presidency_race/planning_boards/cancel.png"
            action [Hide("planning_board_confirm_task"), Hide("planning_board_task_desc"), Hide("planning_board")]
