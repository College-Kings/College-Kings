...
label v13s02:
    ...
    scene v13s02_1c # TPP. imre taps mc's shoulder from behind, mc slight shock, mouth open
    with dissolve

    imre "BOO!"

    scene v13s02_2 # FPP. mc turns around and sees imre, imre slight smile, mouth open
    with dissolve

    imre "Did I scare you?"

    scene v13s02_2a # FPP. imre slight smile mouth closed
    with dissolve
    ...
    scene v13s02_2b # FPP. same as v13s02_2 imre is excited
    with dissolve

    imre "Ryan and I are headed to the Red Light District for our last night in Europe. You wanna come with?"

    scene v13s02_2c # FPP. same as v13s02_2b imre mouth closed
    with dissolve
    ...
    scene v13s02_2f # FPP. same as v13s02_2a Ryan walks up behind imre, looking at imre, imre turns around to look at ryan, ryan no expression mouth open, imre mouth closed no expression
    with dissolve

    ry "Imre, he isn't in his-"

    scene v13s02_2g # FPP. same as v13s02_2f ryan is standing beside imre, imre and ryan looking at mc
    with dissolve

    ry "Oh... Hey [name]."

    scene v13s02_2h # FPP. same as v13s02_2g ryans mouth closed
    with dissolve
    ...
    scene v13s02_2j # FPP. same as v13s02_2i ryans mouth open
    with dissolve
    ...
    scene v13s02_2k # FPP. same as v13s02_2j imres mouth open
    with dissolve
    ...
    scene v13s02_3 # TPP. mc, ryan, and imre walk towards the hotels front door, all slight smiles, mouths closed, looking straight ahead
    with dissolve

    pause 0.75

    scene v13s02_4 # TPP. mc, ryan, and imre seen leaving the hotel from the street view, all slight smiles, mouths closed, looking straight ahead
    with dissolve
