...
label v14s25a:
    ...
    image v14ambmoTPP = Movie(play="images/v14/Scene 3d/v14ambmoTPP.webm", loop=True, image="images/v14/Scene 3d/v14ambmoTPP.webp", start_image="images/v14/Scene 3d/v14ambmoTPP.webp")
    image v14ambmoTPPf = Movie(play="images/v14/Scene 3d/v14ambmoTPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambmoTPP.webp", start_image="images/v14/Scene 3d/v14ambmoTPP.webp")
    ...
    image v14ambmFPP = Movie(play="images/v14/Scene 3d/v14ambmFPP.webm", loop=True, image="images/v14/Scene 3d/v14ambmFPP.webp", start_image="images/v14/Scene 3d/v14ambmFPP.webp")
    image v14ambmFPPf = Movie(play="images/v14/Scene 3d/v14ambmFPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambmFPP.webp", start_image="images/v14/Scene 3d/v14ambmFPP.webp")
    ...
    image v14ambmTPP = Movie(play="images/v14/Scene 3d/v14ambmTPP.webm", loop=True, image="images/v14/Scene 3d/v14ambmTPP.webp", start_image="images/v14/Scene 3d/v14ambmTPP.webp")
    image v14ambmTPPf = Movie(play="images/v14/Scene 3d/v14ambmTPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambmTPP.webp", start_image="images/v14/Scene 3d/v14ambmTPP.webp")
    ...
    image v14ambtbFPP = Movie(play="images/v14/Scene 3d/v14ambtbFPP.webm", loop=True, image="images/v14/Scene 3d/v14ambtbFPP.webp", start_image="images/v14/Scene 3d/v14ambtbFPP.webp")
    image v14ambtbFPPf = Movie(play="images/v14/Scene 3d/v14ambtbFPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambtbFPP.webp", start_image="images/v14/Scene 3d/v14ambtbFPP.webp")
    ...
    image v14ambtbTPP = Movie(play="images/v14/Scene 3d/v14ambtbTPP.webm", loop=True, image="images/v14/Scene 3d/v14ambtbTPP.webp", start_image="images/v14/Scene 3d/v14ambtbTPP.webp")
    image v14ambtbTPPf = Movie(play="images/v14/Scene 3d/v14ambtbTPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambtbTPP.webp", start_image="images/v14/Scene 3d/v14ambtbTPP.webp")
    ...
    image v14ambrcgFPP = Movie(play="images/v14/Scene 3d/v14ambrcgFPP.webm", loop=True, image="images/v14/Scene 3d/v14ambrcgFPP.webp", start_image="images/v14/Scene 3d/v14ambrcgFPP.webp")
    image v14ambrcgFPPf = Movie(play="images/v14/Scene 3d/v14ambrcgFPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambrcgFPP.webp", start_image="images/v14/Scene 3d/v14ambrcgFPP.webp")
    ...
    image v14ambrcgTPP = Movie(play="images/v14/Scene 3d/v14ambrcgTPP.webm", loop=True, image="images/v14/Scene 3d/v14ambrcgTPP.webp", start_image="images/v14/Scene 3d/v14ambrcgTPP.webp")
    image v14ambrcgTPPf = Movie(play="images/v14/Scene 3d/v14ambrcgTPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambrcgTPP.webp", start_image="images/v14/Scene 3d/v14ambrcgTPP.webp")
    ...
    image v14ambjoFPP = Movie(play="images/v14/Scene 3d/v14ambjoFPP.webm", loop=True, image="images/v14/Scene 3d/v14ambjoFPP.webp", start_image="images/v14/Scene 3d/v14ambjoFPP.webp")
    image v14ambjoFPPf = Movie(play="images/v14/Scene 3d/v14ambjoFPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambjoFPP.webp", start_image="images/v14/Scene 3d/v14ambjoFPP.webp")
    ...
    image v14ambjoTPP = Movie(play="images/v14/Scene 3d/v14ambjoTPP.webm", loop=True, image="images/v14/Scene 3d/v14ambjoTPP.webp", start_image="images/v14/Scene 3d/v14ambjoTPP.webp")
    image v14ambjoTPPf = Movie(play="images/v14/Scene 3d/v14ambjoTPPf.webm", loop=True, image="images/v14/Scene 3d/v14ambjoTPP.webp", start_image="images/v14/Scene 3d/v14ambjoTPP.webp")
