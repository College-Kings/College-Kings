...
label v14s30b:
    ...
    if not v14_realwolf and v14s30b_image == 1 and v14s30b_its_perfect:
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost1.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost1.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost1.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost1.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost1.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost1.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost2.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost2.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost2.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost2.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost2.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost2.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost3.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost3.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost3.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost3.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost3.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost3.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost4.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost4.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost4.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost4.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost4.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost4.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost5.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost5.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost5.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost5.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost5.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost5.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost6.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost6.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost6.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost6.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost6.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost6.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost7.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost7.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost7.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost7.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost7.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost7.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        ...
        if v14_chrissupport > 1:
            $ v14s30b_kiwiiPost8.newComment(chris, _("Haha, perfect! #Vote4Chloe"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost8.newComment(aubrey, _("Aww! Hell yeah! This is so cute, Chloe <3"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost8.newComment(imre, _("Yessss!!!!!"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost8.newComment(grayson, _("LMAO you're down bad, huh?"), numberLikes=renpy.random.randint(15, 35), queue=False)
        $ v14s30b_kiwiiPost8.newComment(chloe, _("Be civil at least, Grayson"), numberLikes=renpy.random.randint(15, 35), mentions=[grayson], queue=False)
        $ v14s30b_kiwiiPost8.newComment(riley, _("Omg! Can I have that thing?"), numberLikes=renpy.random.randint(15, 35), queue=False)
