...
define kneeBlock = DefensiveMove("KneeBlock")
define highGuard = DefensiveMove("HighGuard")
define lowGuard = DefensiveMove("LowGuard")
define sideGuard = DefensiveMove("SideGuard")

define kick = FightMove("Kick", 10, kneeBlock)
define bodyJab = FightMove("BodyJab", 10, lowGuard)
define jab = FightMove("Jab", 10, highGuard)
define hook = FightMove("Hook", 10, kneeBlock)

default players = []

default mc = FightCharacter("MC", 50)
default lars = FightCharacter("Lars", 50)