...
label v16s48: # 48) Baby night: Chloe & MC
    ...
    u "(Poor [baby_name]... Is this child neglect?) *Laughs*"
    ...
    scene v16s48_5 # FPP MC's view of the TV (or laptop or whatever) showing a dramatic moment. Woman on TV has mouth open
    with dissolve

    wtv "I've always known the truth about you."


    scene v16s48_5a # FPP Same angle as 5. Different angle on the dramatic moment in the show, Man on TV has mouth open
    with dissolve
    ...
    scene v16s48_6d # FPP Same angle as 6, Chloe (neutral expression, mouth open) next to MC. She has handed of the doll and is watching the TV
    with dissolve
    ...
    while v16s48_wrong_key:
        menu:
            "Blue":
                ...
                scene v16s48_12 # FPP MC holding the baby up in front of him with both hands in victory
                with dissolve
    ...
    menu:
        "Care for baby":
            ...
            u "[baby_name] just needs to burp and then we can get back to sleep."


            scene v16s48_16a
            with dissolve

            cl "*Scoffs* Calling it [baby_name]. It's a piece of plastic, [name]!"
        ...
        "Complain about baby":
            ...
            while v16s48_wrong_key:
                menu:
                    ...
                    "Green":
                        ...
                        u "There, [baby_name]. You've burped. Now leave us in peace!"
            ...
            scene v16s48_22 # TPP Chloe holding the doll and walking away from the couch toward the window, MC looks wide-eyed and confused
            with dissolve

            cl "No. Nope. I'm done! We. Are. Done."


            scene v16s48_23 # TPP Show Chloe (neutral expression, mouth open) casually tossing the baby doll out the window
            with dissolve
            ...
            menu:
                "Freak out":
                    scene v16s48_24 # FPP MC's view from behind Chloe as she closes the window
                    with dissolve
                    ...
                    scene v16s48_24c # FPP Same angle as 24, Chloe (slight smile, mouth open) hooking her thumb back to point toward the window
                    with dissolve
                ...
                "Laugh":
                    ...
                    if relationship.chloe == Relationship.FRIEND: # -if ChloeFriend
                    ...
                    elif relationship.chloe == Relationship.GIRLFRIEND: # -if ChloeGF
