...
label v16s25a:
    ...
    if v16s11_sign_up:
        $ riley.messenger.addReply("What about me? Do you know?", v16s25a_reply1) 
        $ riley.messenger.addReply("Ah, nice. I was kind of hoping I didn't get it, haha.", v16s25a_reply2)

    label v16s25a_phoneContinue:
        if riley.messenger.replies:
            call screen phone
        if riley.messenger.replies:
            u "(I should reply to Riley.)"
            jump v16s25a_phoneContinue
