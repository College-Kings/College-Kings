...
label v16s47: # 47) MC goes to the Chicks house
    ...
    if v16_chloe_partner: # PLACEHOLDER VARIABLE # IF partnered with Chloe
        ...
        no "Look who it is, [baby_name]! It's your daddy!"
        ...
        if relationship.nora >= Relationship.FWB: # VERIFY, SINCE RS NO LONGER MEANS ANYTHING ### ERROR: IF noraRS
