...
label v16s54: # 55) Prepare Lindsey for the interview
    ...
    if v16s55_question1: # -if Can you say three positive things about your opponent? [Checkpoint 1.1]
        scene v16s55_3e
        with dissolve
    ...
    if v16s55_question2: # -if What is the most important quality of a good president? [Checkpoint 1.2]
        scene v16s55_3e
        with dissolve
    ...
    if v16s55_question3: # -if What was your last random act of kindness? [Checkpoint 1.3]
        scene v16s55_3e
        with dissolve
        ...
        if (v16s25a_date_with_aubrey = False and v16_lindsey_full_donation) # SECOND VARIABLE IS A PLACEHOLDER
            scene v16s55_3e
            with dissolve
        ...
        elif v16_lindsey_some_donation: # PLACEHOLDER VARIABLE
            scene v16s55_3e
            with dissolve
        ...
        elif v16_lindsey_no_donation: # PLACEHOLDER VARIABLE
            scene v16s55_3e
            with dissolve
        ...
        elif (v16_lindsey_no_donation and v16_kiwii_dog_shelter_post): # PLACEHOLDER VARIABLES
            scene v16s55_3c
            with dissolve    
    ...
    if v16_elijah_interview: # PLACEHOLDER VARIABLE
        scene v16s55_3b
        with dissolve
    ...
    menu:
        "More advice": # -if More advice [Checkpoint 1.4]
            ...
            if v16_elijah_interview: # PLACEHOLDER VARIABLE # -if being interviewed by Elijah
    ...
    # -if LindseyRS
    if relationship.lindsey >= Relationship.FWB: # NOT SURE IF CORRECT CHECK SINCE "RS" MEANS SOMETHING DIFFERENT FOR EVERY GIRL
