...
# Characters: MC (Outfit: 6), MS ROSE (Outfit:5), Old Woman, Tenor, Soprano
# Time: Friday night
...
label v16s78: # 78) At the Opera with Ms Rose
    ...
    menu:
        "If we want to":
            ...
            $ v16s78_rose_ask_mc_contnue_dating = 2
    ...
    if v16s78_rose_ask_mc_contnue_dating == 2: # -if Probably not
