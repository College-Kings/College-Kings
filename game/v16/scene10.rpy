...
label v16s10: # Econ class
    ...
    if v15s18_LAUREN_SEX: # PLACEHOLDER VARIABLE # if MC and Lauren had sex after Lauren's party
    ...
    if (lauren.relationship == Relationship.FWB or lauren.relationship == Relationship.GIRLFRIEND): # PLEASE VERIFY - MY FIRST EXPERIENCE WITH THE NEW RELATIONSHIP SYSTEM # -if LaurenRS or LaurenSex
        ...
        menu:
            "Hooked up with each other":
                scene v16s10_8 # TPP MC leaning over to whisper in Lauren's ear
                with dissolve
        ...
        scene v16s10_2e # TPP Same angle as 2, Lauren laughing while trying to stay quiet
        with dissolve
    ...
    if lauren.relationship == Relationship.FRIEND: # -if LaurenFriend
    ...
    elif (lauren.relationship == Relationship.FWB or lauren.relationship == Relationship.GIRLFRIEND): # -if LaurenRS or LaurenSex
        scene v16s10_2c
        with dissolve
        ...
        menu:
            ...
            "Let her continue":
                ...
                image v16lahjTPP = Movie(play="images/v14/Scene 3d/v16lahjTPP.webm", loop=True, image="images/v14/Scene 3d/v16lahjTPP.webp", start_image="images/v14/Scene 3d/v16lahjTPP.webp")

                # Second angle - FPP of handjob
                image v16lahjFPP = Movie(play="images/v14/Scene 3d/v16lahjFPP.webm", loop=True, image="images/v14/Scene 3d/v16lahjFPP.webp", start_image="images/v14/Scene 3d/v16lahjFPP.webp")
                ...
                image v16lahjTPPf = Movie(play="images/v14/Scene 3d/v16lahjTPPf.webm", loop=True, image="images/v14/Scene 3d/v16lahjTPP.webp", start_image="images/v14/Scene 3d/v16lahjTPP.webp")

                # Second angle - FPP of handjob, but faster
                image v16lahjFPPf = Movie(play="images/v14/Scene 3d/v16lahjFPPf.webm", loop=True, image="images/v14/Scene 3d/v16lahjFPP.webp", start_image="images/v14/Scene 3d/v16lahjFPP.webp")
    ...
    if (lauren.relationship == Relationship.FWB or lauren.relationship == Relationship.GIRLFRIEND):
...
# -regardless-
jump b16s11 # -Transition to Scene 11-