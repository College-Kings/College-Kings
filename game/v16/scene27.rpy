...
# -Regardless of parent choice-
    ...
    if v16s27parent_chloe: # -if MC is parenting with Chloe
        scene v16s27_8
        with dissolve
    ...
    #!#!#!#!# -The UI pops up, showing the three nights, and MC can choose the baby-duty schedule- #!#!#!#!#
    ...
    if v16s27parent_chloe: # -if chloe partner
        scene v16s27_8a
        with dissolve
        ...
        scene v16s27_8f # FPP. Show just Chloe (slight smile, mouth is open, looking at MC) sitting in her seat with her phone in her hands, camera angle is from a seated positon
        with dissolve
    ...
    if v16s27parent_chloe: # -if MC is parenting with Chloe
        ...
        u "That sounds great, and I'm happy for you... But let's see how you do at 4am when [BABY_NAME] needs a diaper change. *Laughs*"
    ...
    if v14_help_lindsey:    # -if MC is helping Lindsey
        ...
        scene v16s27_14b # TPP. Show MC (slight smile, mouth is closed, looking at Lindsey) with his hands in the air like he surrenders, and Lindsey (slight smile, mouth is closed, looking at MC) standing at the exit to the Amphitheatre
        with dissolve
