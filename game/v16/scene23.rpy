...
# Characters: MC (Outfit: 5), AMBER (Outfit: stripper), DRUNK SLEAZE
# Time: Tuesday night


default v16s23_mention_bills = False
default v16s23_mention_laptop = False
...
label v16s23: # 23) Meet Amber at strip club
    ...
    scene v16s23_1 # TPP Show MC approaching Amber outside of the strip club. Amber is smoking a cigarette, not looking at MC. MC's mouth open, if visible, and he's waving at Amber
    with fade

    u "Hey, Amber."


    scene v16s23_2 # FPP Show Amber looking at MC, she looks excited or nervous, mouth open
    with dissolve

    am "[name]! Did you get my charger?"


    scene v16s23_2a # FPP Same angle as 2, MC holding a phone charger out to Amber. Amber is looking at the charger with a slight smile, mouth closed
    with dissolve

    u "Yeah, here it is."


    scene v16s23_2b # FPP Same angle as 2, Amber has taken the charger from MC. She looks relieved, with a slight smile, mouth open
    with dissolve

    am "You saved my fucking life."


    scene v16s23_3 # TPP Show Amber throwing away her cigarette, the phone charger in her other hand
    with dissolve

    pause 0.75


    scene v16s23_3a # TPP Same angle as 3. Show Amber giving MC a hug, the phone charger in her hand
    with dissolve

    pause 0.75


    if v16s20_twazzlers: # -if MC also took the Twazzlers
        scene v16s23_2c # FPP Same angle as 2, Amber with a slight smile, mouth closed, MC is holding Twazzlers package out to her
        with dissolve

        u "I grabbed these too. Thought you might appreciate it."


        scene v16s23_2d # FPP Same angle as 2, Amber taking the Twazzlers with a big smile, mouth open
        with dissolve

        am "Amazing! I haven't eaten all day!"


        scene v16s23_2e # FPP Same angle as 2, Amber eating one of the Twazzlers
        with dissolve

        pause 0.75


        scene v16s23_2f # FPP Same angle as 2, Amber looking into the now empty Twazzlers package. She looks angry or annoyed, mouth open
        with dissolve

        am "Only one?!"


        scene v16s23_2g # FPP Same angle as 2, Amber looking at MC and holding empty Twazzlers package, neutral expression, mouth closed
        with dissolve

        u "Aw, shit, really? Sorry, I just grabbed them off the table."


        scene v16s23_2h # FPP Same angle as 2, Amber looking at MC and holding empty Twazzlers package, neutral expression, mouth open
        with dissolve

        am "Ah, it'll be enough to keep me going."


        scene v16s23_3b # TPP Same angle as 3. Show Amber throwing the empty Twazzlers package on the ground
        with dissolve
    ...
    scene v16s23_2i # FPP Same angle as 2, Amber looking at MC with a neutral expression, mouth open
    with dissolve

    am "Let's go inside."


    scene v16s23_4 # TPP Show Amber walking into the strip club, with MC following close behind
    with dissolve

    pause 0.75


    scene v16s23_5 # FPP Show Amber barely visible behind the bar, she is ducking down to plug in her phone. Her face is not visible
    with dissolve
    ...
    scene v16s23_6 # FPP MC's view as he looks around the inside of the strip club
    with dissolve

    u "So, this is where the magic happens?"


    scene v16s23_7 # FPP View from another angle of the interior of the strip club
    with dissolve

    am "Yeah, what do you think?"


    scene v16s23_8 # FPP A stripper walks by wearing nothing but a thong. She is looking at MC side-eyed with a slight smile
    with dissolve

    u "I'm warming up to it, haha."


    scene v16s23_9 # FPP Amber back from behind the bar, looking at MC with a slight smile, mouth open
    with dissolve
    ...
    scene v16s23_11 # FPP Show Amber in her seat next to the catwalk, looking at MC with a slight smile, mouth open
    with dissolve

    am "Honestly, yes. I mean-"


    scene v16s23_11a # FPP Same angle as 11, Amber looking up at the catwalk, slight smile, mouth open
    with dissolve

    am "The crowd isn't so great on weekdays, but on weekends..."


    scene v16s23_11b # FPP Same angle as 11, Amber leaning toward MC with a large, sneaky smile, mouth open
    with dissolve
    ...
    scene v16s23_ # TPP They are interrupted as a drunk guy steps between them to talk to Amber. It's the same guy who was the Male Buyer in v15 scene 10 (MC selling Lindsey's car). His mouth is open
    with dissolve

    ds "Hey sweetheart, aren't you gonna get up there and dance for me?"


    scene v16s23_# TPP Same angle as 12, The drunk guy's mouth is closed. MC looks very annoyed
    with dissolve
    ...
    menu:
        "We're talking":
            ...
            scene v16s23_13 # FPP MC is looking up at the drunk guy, who has shoved in between him and Amber. The drunk guy is looking at Amber, Amber has a slight smile
            with dissolve

            u "Um, we're in the middle of a conversation, dude. Do you mind?"


            scene v16s23_13a # FPP Same angle as 13, Drunk guy is now looking at MC with an angry expression, mouth open
            with dissolve
            ...
            scene v16s23_13b # FPP Same angle as 13, Drunk guy is looking back at Amber. If his face is visible, he is smiling with his mouth open
            with dissolve
    ...
    # -Regardless-
    scene v16s23_13c # FPP Same angle as 13, Amber looking up at the drunk guy, slight smile and mouth open
    with dissolve

    am "Sorry, honey. I'm with another client right now. I'll come find you later, okay?"


    scene v16s23_13d # FPP Same angle as 13. Drunk guy looking down at Amber, but pointing at MC with his thumb. His face, if visible, has an annoyed expression, mouth open
    with dissolve
    ...
    scene v16s23_13e # FPP Same angle as 13. Amber is still looking up at Drunk Guy with a slight smile, but she is holding her hand up, palm out, in front of her
    with dissolve
    ...
    scene v16s23_13f # FPP Same angle as 13. Drunk guy leaning down to whisper in Amber's ear, smiling with mouth open
    with dissolve
    ...
    if v15s10_met_buyer: # PLACEHOLDER VARIABLE # -if MC met Male Buyer in v15 scene 10
        scene v16s23_13
        with dissolve
        ...
        scene v16s23_13g # FPP Same angle as 13. Drunk guy turning to look at MC, he has a drunken smile, mouth open
        with dissolve

        ds "Huh? Oh... Yeah!"


        scene v16s23_13h # FPP Same angle as 13. Drunk guy now turned fully toward MC, he still has a drunken smile, mouth open
        with dissolve
        ...
        scene v16s23_13i # FPP Same angle as 13. Drunk guy is turned fully toward MC. Amber is looking at the back of his head with a disgusted expression, mouth open
        with dissolve

        am "...Wow."


        scene v16s23_13j # FPP Same angle as 13. Drunk guy is turned fully toward MC with a drunken smile, mouth closed
        with dissolve
    ...
    scene v16s23_12b # TPP Same angle as 12. The drunk guy is walking away, MC and Amber watch him go
    with dissolve

    pause 0.75


    scene v16s23_11c # FPP Same angle as 11. Amber looking at MC with a slight smile, mouth closed
    with dissolve
    ...
    scene v16s23_14 # TPP Show Amber up from her seat, MC is getting up to follow her
    with dissolve

    pause 0.75


    scene v16s23_15 # TPP Show Amber and MC entering private booth
    with dissolve

    pause 0.75


    scene v16s23_16 # TPP Show MC and Amber sitting next to each other in the private booth, Amber looking at MC with a slight smile, mouth open
    with dissolve

    am "So, it went okay, getting into my place?"


    scene v16s23_17 # FPP View of Amber next to MC in the private booth. She is looking at MC with a slight smile, mouth closed
    with dissolve

    u "Oh, yeah. Found the key, went inside. Easy enough."


    scene v16s23_17a # FPP Same angle as 17, Amber looking at MC with a slight smile, mouth open
    with dissolve

    am "Good. People tell me not to keep a key under the mat, but it's saved me so many times, haha."


    if v16s20_bills: # # PLACEHOLDER VARIABLE -if MC looked at the Unpaid bills
        scene v16s23_17
        with dissolve
        ...
        menu:
            "Ask about bills":
                ...
                scene v16s23_17b # FPP Same angle as 17, Amber looking at MC with an angry expression, mouth open
                with dissolve

                am "You were looking at my mail? My bills?"


                scene v16s23_17c # FPP Same angle as 17, Amber looking at MC with a slightly angry expression, mouth closed
                with dissolve

                u "I just saw them when I was looking for the charger."


                scene v16s23_17d # FPP Same angle as 17, Amber looking at MC with a neutral expression, mouth open
                with dissolve

                am "Okay... Well, for starters, don't read my mail ever again."


                scene v16s23_17e # FPP Same angle as 17, Amber looking at MC with a neutral expression, mouth closed
                with dissolve
    ...
    # -Regardless-
    if v16s20_laptop: # PLACEHOLDER VARIABLE # -if MC looked at the Open laptop
        scene v16s23_17
        with dissolve
        ...
        menu:
            "Mention her laptop":
                ...
                scene v16s23_17f # FPP Same angle as 17, Amber looking at MC and laughing, mouth open
                with dissolve
    ...
    # -Regardless-
    if v16s20_photos: # PLACEHOLDER VARIABLE # -if MC looked at the Photos
        scene v16s23_17
        with dissolve
        ...
        menu:
            "Ask about photos":
                ...
                scene v16s23_17g # FPP Same angle as 17, Amber is looking away, neutral expression, mouth open
                with dissolve
                ...
                if (amber.relationship >= Relationship.FWB or kct==confident): # This is a guess based on the new relationship system. It would be nice if everyone was using the same language for relationship stuff
                    scene v16s23_17d
                    with dissolve
                    ...
                    scene v16s23_17h # FPP Amber looking annoyed and rolling her eyes, mouth open
                    with dissolve
    ...
    if amber.relationship >= Relationship.FWB: # Again, a guess at what the writer was getting at in the new relationship system
        scene v16s23_18 # FPP Amber stepping up onto the small table in the private booth
        with dissolve

        u "Oh, are you going to show me some of your dancing skills?"


        scene v16s23_19 # FPP Amber now standing on the table, smiling down at MC, mouth open
        with dissolve

        am "Haha, angling for a freebie?"


        scene v16s23_19a # FPP Same angle as 19, Amber on the table smiling down at MC, mouth closed
        with dissolve
        ...
        scene v16s23_19b # FPP Same angle as 19, Amber beginning to dance sexy for MC, slight smile, mouth closed
        with dissolve

        u "Damn... You're pretty good at this, Amber!"


        scene v16s23_20 # FPP Show Amber removing her top while she dances for MC. He is smiling and Amber is smiling with her mouth open
        with dissolve

        am "I would hope so, haha."


        scene v16s23_19c # FPP Same angle as 19, Amber in a different pose dancing for MC, she is now topless
        with dissolve

        u "I'm starting to get flashbacks of Lauren's birthday party..."


        scene v16s23_21 # TPP Amber, now topless, dancing for MC. She is now on her hands and knees on the table, one finger pushing on MC's chest, her mouth open
        with dissolve
        ...
        scene v16s23_22 # TPP Amber is now on the table on her knees with her back to MC, her hands up in her hair, mouth open
        with dissolve

        am "Sexually hypnotic, huh? Never heard that one before."


        scene v16s23_23 # FPP Amber is done dancing, getting down from the table
        with dissolve

        u "Aw, is it over already?"


        scene v16s23_24 # FPP Amber is standing in front of MC, putting her top back on, slight smile at MC with her mouth open
        with dissolve

        am "Afraid so. I need to go find some actual paying customers."


        scene v16s23_25 # TPP Show MC standing up in front of Amber
        with dissolve
        ...
        menu:
            "Be thankful":
                ...
                scene v16s23_26 # FPP MC's view standing in front of Amber. Amber has a slight smile, mouth closed
                with dissolve
            ...
            "Complain":
                ...
                scene v16s23_26b # FPP Same angle as 26, Amber laughing at MC, playfully pushing him, her mouth open
                with dissolve
        ...
        scene v16s23_27 # TPP MC and Amber having a quick hug
        with dissolve

        pause 0.75


        scene v16s23_28 # TPP MC leaving the private booth, Amber smiling and watching him go
        with dissolve
    ...
    if amber.relationship >= Relationship.friend: # -if AmberFriend [Checkpoint 1.2]
        scene v16s23_18 # -Amber steps up onto the small table-
        with dissolve
        ...
        scene v16s23_19e # FPP Same angle as 19, Amber standing on the table, testing her balance
        with dissolve

        pause 0.75


        scene v16s23_23a # FPP Same angle as 23. Amber getting down from the table, but her top is on. She has a slight smile, mouth open
        with dissolve
        ...
        # -Regardless-
        scene v16s23_29 # FPP Amber stands up in the private booth. Amber has a slight smile, mouth open
        with dissolve
        ...
        if v16s23_support_amber:
            ...
            scene v16s23_28a # TPP Same angle as 28. MC is leaving the booth, Amber watching him go with a neutral expression.
            with dissolve
    ...
    scene v16s23_31 # TPP Show MC walking out of the strip club
    with dissolve

    pause 0.75


    scene v16s23_32 # TPP MC is back outside the strip club, where Amber was smoking, and the drunk idiot from earlier is leaning against the wall with one hand and urinating, mouth open
    with dissolve

    ds "Ahhh... The seal has been broken!"


    scene v16s23_33 # FPP MC looking at the drunk guy, who is finishing up the process of urinating on the wall
    with dissolve
    ...
    menu:
        "Knock him out":
            ...
            scene v16s23_34 # TPP Show MC walking toward the drunk guy, who is zipping his pants. MC looks angry and is yelling
            with dissolve

            u "Hey dickhead!"


            scene v16s23_35 # TPP Show MC sucker-punching the drunk guy right in the jaw
            with dissolve
            ...
            scene v16s23_36 # FPP MC looking down at drunk guy, who is on the ground rubbing his jaw, mouth closed
            with dissolve

            u "Don't ever speak to a woman like you did in there again. You hear me?"


            scene v16s23_36a # FPP Same angle as 36, MC looking down at the drunk guy, who is on the ground rubbing his jaw, mouth open
            with dissolve

            ds "*Crying* W-wh-where's my mommy..."


            scene v16s23_37 # TPP MC walking away from the strip club, a self-satisfied smirk on his face, rubbing the knuckles of the hand he used to punch the drunk guy
            with dissolve
        ...
        "Give him a break":
            ...
            scene v16s23_37a # TPP Same angle as 37. MC walking away from the strip club
            with dissolve
