...
# ACHIEVEMENT ITEMS HERE
    ...
    if renpy.loadable("v11/scene1.rpy"):
        ...
        Achievement("off_your_high_horse", _("Don't balance the horse at the end of the manhunt"))
        ...
        Achievement("political_strategist", _("Tell Autumn you're into politics and encourage Lindsey to run"))
    ...
    if renpy.loadable("v12/scene1.rpy"):
        ...
        Achievement("thrown_to_the_lions", _("Encourage Lindsey to run but then tell Aubrey and Chloe about it"))
