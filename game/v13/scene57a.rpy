# SCENE 57a: Giving Mr Lee his present
...
label v13s57a:
    ...
    scene v13s57a_2a # FPP. Same as v13s57a_2, Nora slight smile, mouth open.
    with dissolve

    no "Yeah I'll call him."

    scene v13s57a_2b # FPP. Same as v13s57a_2, Nora looking at her phone, slight smile, mouth closed.
    with dissolve
    ...
    scene v13s57a_2d # FPP. Same as v13s57a_2c, Nora slight smile, mouth closed.
    with dissolve
    ...
    scene v13s57a_4a # FPP. Same as v13s57a_4, Mr. Lee standing infront of MC and Nora (Nora off camera), slight smile, mouth open.
    with dissolve

    lee "Please be quick. I have much to do this morning as I try to get things prepared for us to head back to campus."

    scene v13s57a_2e # FPP. MC looking at Nora. Nora looking at Mr.Lee(Off camera), Nora slight smile, mouth open.
    with dissolve
    ...
    scene v13s57a_5 # FPP. Nora picking up the Bonsai tree, slight smile, mouth closed,
    with dissolve
    ...
    scene v13s57a_2f # FPP. Same as v13s57a_2a, Nora looking at Mr. Lee(off camera), Nora worried expression, mouth open.
    with dissolve
    ...
    scene v13s57a_4c # FPP. Same as v13s57a_4b, Mr. Lee looking at MC, slight smile, mouth closed.
    with dissolve

    u "No offense taken."

    scene v13s57a_4d # FPP. Same as v13s57a_4c, Mr. Lee slight smile, mouth open. 
    with dissolve
