...
label v13s39a:
    ...
    if v10s33_ryan_flirt_emily and emily_europe:
        ...
        elif CharacterService.is_girlfriend(lauren, Relationship.GIRLFRIEND) and not v11_lauren_caught_aubrey: #second part of check only for compatibility purposes
