...
define character.male_buyer = Character("Male Buyer")
define character.female_buyer = Character("Female Buyer")
...
define character.barworker = Character("barworker")
define character.admin = Character("booking admin")